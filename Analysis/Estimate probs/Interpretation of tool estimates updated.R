...
p1 <- ggplot(death, aes(x = Median, y = 1/Median)) +
  ...
  scale_x_continuous(limits = c(-0.025,0.6), expand = c(0,0)) +
  #xlim(-0.025,0.6) +
  #geom_hline(yintercept = (32200*37)/3800, linetype = "dashed") # cost effectiveness threshold, 1/0.0032
  # Add low risk example from discussion
  #geom_hline(yintercept = (1/0.54), linetype = "dashed") +
  geom_segment(aes(x = -0.025, xend = 0.54, y = (1/0.54), yend = (1/0.54)), linetype = "dashed") +
  geom_segment(aes(x = 0.54, xend = 0.54, y = 0, yend = (1/0.54)), linetype = "dashed") +
  # Add high risk example from discussion
  #geom_hline(yintercept = (1/0.000007), linetype = "dashed") 
  #geom_vline(xintercept = 0.000007 , linetype = "dashed") 
  geom_segment(aes(x = -0.025, xend = 0.000007, y = (1/0.000007), yend = (1/0.000007)), linetype = "dashed") +
  geom_segment(aes(x = 0.000007, xend = 0.000007, y = 0, yend = (1/0.000007)), linetype = "dashed") +
  geom_text(aes(x = 0.1, y = 142000, label = "Low risk")) +
  geom_text(aes(x = 0.5, y = 80, label = "High risk")) +
  geom_point(aes(x = 0.000007, y = (1/0.000007)), color = "black") +
  geom_point(aes(x = 0.54, y = (1/0.54)), color = "black") 
...
p2 <- ggplot(death, aes(x = Median, y = 3800*(1/Median))) + #Pieracci, E. et al. Vital Signs: Trends in Human Rabies Deaths and Exposures — United States, 1938–2018. MMWR Morb Mortal Wkly Rep 68, 524-528, doi:https://dx.doi.org/10.15585%2Fmmwr.mm6823e1 (2019).
  ...
  # Low risk exposure
  geom_segment(aes(x = -0.025, xend = 0.54, y = 3800*(1/0.54), yend = 3800*(1/0.54)), linetype = "dashed") +
  geom_segment(aes(x = 0.54, xend = 0.54, y = 0, yend = 3800*(1/0.54)), linetype = "dashed") +
  # High risk exposure
  geom_segment(aes(x = -0.025, xend = 0.000007, y = 3800*(1/0.000007), yend = 3800*(1/0.000007)), linetype = "dashed") +
  geom_segment(aes(x = 0.000007, xend = 0.000007, y = 0, yend = 3800*(1/0.000007)), linetype = "dashed") +
  geom_text(aes(x = 0.1, y = 3800*142000, label = "Low risk")) +
  geom_text(aes(x = 0.5, y = 3800*80, label = "High risk")) +
  geom_point(aes(x = 0.000007, y = 3800*(1/0.000007)), color = "black") +
  geom_point(aes(x = 0.54, y = 3800*(1/0.54)), color = "black") 
